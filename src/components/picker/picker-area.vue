    ...
    <div class="picker-list-wrapper" ref="wrapper">
      ...
      <div class="picker-list">
        ...
        <list class="picker-list-item">
          <cell v-for="(item, index) in provinceState.data"
                                :key="index">
        ...
        <list class="picker-list-item borderlr">
          <cell v-for="(item, index) in cityState.data"
                                :key="index">
        ...
        <list class="picker-list-item">
          <cell v-for="(item, index) in areaState.data"
                                :key="index">
  ...
  export default {
    ...
    methods: {
      initData(){
          ...
          this['provinceState'].data.forEach(function (item) {
            item.current = false
          })
